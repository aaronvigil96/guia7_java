...
public class Ejercicio_2 {
    public static void main(String[] args) {
        CuentaBancariaService manejadorCuentaBancaria = new CuentaBancariaService();
        
        CuentaBancaria usuario1 = manejadorCuentaBancaria.crearCuenta();
        manejadorCuentaBancaria.ingresarDinero(usuario1);
        manejadorCuentaBancaria.retirarDinero(usuario1);
    }
}
