...
public class Ejercicio_4 {
    public static void main(String[] args) {
        ...
        PersonaService manejadorPersona = new PersonaService();
        Persona persona1 = manejadorPersona.crearPersona();
        Persona persona2 = manejadorPersona.crearPersona();
        Persona persona3 = manejadorPersona.crearPersona();
        Persona persona4 = manejadorPersona.crearPersona();
        System.out.println(manejadorPersona.calcularIMC(persona2));
